  ...
  routes: [
    ...
    { path: '/register', name: 'Register', component: () => import('../views/Register.vue'), meta: { guest: true } },
    {
      ...
      children: [
        ...
        { path: 'orders', redirect: { name: 'MyNeeds' } },
        { path: 'mine', name: 'Mine', component: () => import('../views/Mine.vue') },
        { path: 'mine/needs', name: 'MyNeeds', component: () => import('../views/MyNeeds.vue') },
        { path: 'mine/published', name: 'MyPublished', component: () => import('../views/MyPublished.vue') },
